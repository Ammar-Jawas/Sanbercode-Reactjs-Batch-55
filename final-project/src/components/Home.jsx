...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen">
        <img src={hero} alt="job interview" className="w-full h-screen object-cover top-0 left-0" />
        ...
        <div className="p-4 absolute top-0 left-0 w-full">
            <Navbar fluid rounded className="bg-blur">
                ...
                <Navbar.Toggle />
                <Navbar.Collapse>
                    <Navbar.Link className="text-base text-white" href="#">
                    Home
                    </Navbar.Link>
                    <Navbar.Link className="text-base text-white" href="#">
                    About
                    </Navbar.Link>
                    <Navbar.Link className="text-base text-white" href="#">Services</Navbar.Link>
                    <Navbar.Link className="text-base text-white" href="#">Pricing</Navbar.Link>
                    <Navbar.Link className="text-base text-white" href="#">Contact</Navbar.Link>
                </Navbar.Collapse>
            </Navbar>
        </div>
        {/* Navbar Section End */}
        {/* Hero Section Start */}
        <section className="dark:bg-gray-900 m-auto w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl dark:text-white">Find your best opportunity here</h1>
                <p className="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                    <span className="font-semibold text-white uppercase">FEATURED IN</span>
                    <div className="justify-center items-center mt-8 text-gray-500 sm:justify-between">
                        <TextInput id="email1" type="email" icon={HiSearchCircle} placeholder="Job title, Keyword or Company" color='gray'/>
                        {/* <a href="#" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-white">
        ...
        <div className="inline-flex items-center justify-center w-full px-20 pt-10">
            <hr className="w-full h-px my-8 bg-gray-400 border-0" />
            <span className="absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">Trusted by top company</span>
        </div>
        <div className="px-20 flex text-center justify-between">
            <img src={google} alt="google" className="w-10 h-10"/>
            <img src={netflix} alt="netflix" className="w-10 h-10"/>
            <img src={amazon} alt="amazon" className="w-10 h-10"/>
        ...
        <div className="inline-flex items-center justify-center w-full px-20">
            <hr className="w-full h-px my-8 bg-gray-400 border-0" />            
        </div>
        {/* Company Section End */}
        {/* Card Section Start */}
        <section className="w-full">
            <h1 className="text-2xl font-bold mb-10"> Popular Job </h1>
            <div className="px-20 flex flex-wrap w-full justify-between">
                {renderData()}
            </div>
        </section>
        {/* Card Section End */}
